    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            if (!validationChecker()) {
                ...
                ResultSet rs = new Conn().getData("select * from inventory where id = '" + sess.getSignID() + "'");
                if (rs.next()) {
                    ...
                    if (oldPass.equals(oldHash)) {
                        ...
                        new Conn().updateData("update inventory set password = '" + newPass + "' where id = '" + sess.getSignID() + "'");
